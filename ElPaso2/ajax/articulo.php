...
switch ($_GET["op"]) {
	...
	if (empty($idarticulo)) {
		$rspta=$articulo->insertar($idcategoria,$codigo,$nombre,$stock,$PrecioCosto,$PrecioVenta,$descripcion,$imagen);
		echo $rspta ? "Datos registrados correctamente" : "No se pudo registrar los datos";
	}else{
         $rspta=$articulo->editar($idarticulo,$idcategoria,$codigo,$nombre,$stock,$PrecioCosto,$PrecioVenta,$descripcion,$imagen);
