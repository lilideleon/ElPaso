...
<head>
  ...
  <title>Ferreteria | El Paso</title>
  ...
  <link rel="stylesheet" href="../public/css/material-theme.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-mini"><b>El</b> paso</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>EL</b> PASO</span>
    </a>
...
if ($_SESSION['almacen']==1) {
  echo ' <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="costos.php"><i class="fa fa-circle-o"></i> REPORTE DE COSTOS</a></li>
          </ul>
        </li>';
}
        ?>
...
if ($_SESSION['ventas']==1) {
  echo '<li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="ganancia.php"><i class="fa fa-circle-o"></i> GANANCIA</a></li>
          </ul>
        </li>';
}
        ?>
...
if ($_SESSION['consultac']==1) {
  echo '     <li class="treeview">
          <a href="#">
            <i class="fa fa-bar-chart"></i> <span>REPORTE DE COMPRAS</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="comprasfecha.php"><i class="fa fa-circle-o"></i>POR FECHA</a></li>
          </ul>
        </li>';
}
        ?>  
...
if ($_SESSION['consultav']==1) {
  echo '<li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="ventasfechacliente.php"><i class="fa fa-circle-o"></i> POR FECHA</a></li>
