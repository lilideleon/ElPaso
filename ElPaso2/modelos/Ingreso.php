...
public function listarDetalle($idingreso){
	$sql="SELECT di.idingreso,di.idarticulo,IFNULL(a.nombre,'[Artículo no disponible]') as nombre,di.cantidad,di.precio_compra,di.precio_venta FROM detalle_ingreso di LEFT JOIN articulo a ON di.idarticulo=a.idarticulo WHERE di.idingreso='$idingreso'";
	return ejecutarConsulta($sql);
}
